...
// Виведення отриманої інформації
        ...
        for(int i = 0; i < country.length; i++) { System.out.println(""+country[i].name+"\t"+country[i].square
                + "млн. кв. км");
...
// (початкове значення)
        ...
        System.out.println("\nКраїна з максимальною площею :"); System.out.println(""+country[nommax].name+"\t"+country[nommax].square + "млн кв. км");
